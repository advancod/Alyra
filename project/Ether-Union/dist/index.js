...
async function _creerGroupe() {
    await ethereum.enable()
  	...
  	await contractInstance.creerGroupe(nom,pseudo, {value : 100000})
}
...
async function _ajouterMembre() {
    await ethereum.enable()
  	...
  	await contractInstance.ajouterMembre(membre,groupe,pseudo, {value : 10000})
}
...
async function _demander() {
    ...
    let description = document.getElementById('description').value
  	await contractInstance.demander(montant,pseudo,contrat,description, {value : 1000})
}
